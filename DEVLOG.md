...
> 当前最新：**v41**（2026-09-26，push.js 守卫 ENOENT 判定兼容数字码 2，随本提交落地并上线；服务端代码与 v40 一致）。上一版 v40（全量审查修复批，`33ab617`）。上一版 v39（deferred spread 时序修复，`60654f0`）。上一版 v38（对账文案+文档批，`7781ee1`）。更早：v37（b8db8a6，09-25 值日全面检修）、v36（7a7a361，09-24 值日公平性批）。
