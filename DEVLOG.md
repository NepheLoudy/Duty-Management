...
> 当前最新：**v40**（2026-09-26，`33ab617`，全量审查修复批；09-26 下午随部署批上线）。上一版 v39（deferred spread 时序修复，`60654f0`）。上一版 v38（对账文案+文档批，`7781ee1`）。更早：v37（b8db8a6，09-25 值日全面检修）、v36（7a7a361，09-24 值日公平性批）。
